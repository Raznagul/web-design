...
--
-- Table structure for table `node__field_img`
--

DROP TABLE IF EXISTS `node__field_img`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `node__field_img` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Data storage for node field field_img.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `node__field_img`
--

LOCK TABLES `node__field_img` WRITE;
/*!40000 ALTER TABLE `node__field_img` DISABLE KEYS */;
INSERT INTO `node__field_img` VALUES ('slider',0,5,8,'en',0,2,'galaxy','',2560,1600),('slider',0,6,9,'en',0,3,'void','',450,281),('slider',0,7,10,'en',0,4,'wall','',900,506);
/*!40000 ALTER TABLE `node__field_img` ENABLE KEYS */;
UNLOCK TABLES;
